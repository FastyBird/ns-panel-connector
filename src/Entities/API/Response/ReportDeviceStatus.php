...
/**
 * Report third-party device status to NS Panel response definition
 *
 * @package        FastyBird:NsPanelConnector!
 * @subpackage     Entities
 *
...
final class ReportDeviceStatus implements Entities\API\Entity
{
	...
	public function __construct(
		...
		private readonly ReportDeviceStatusEvent $data,
	...
	public function getData(): ReportDeviceStatusEvent
	{
		return $this->data;
	}
