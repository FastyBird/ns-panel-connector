...
/**
 * NS Panel color temperature channel entity schema
 *
...
final class ColorTemperature extends Channel
{
	 ...
	 */
	public const SCHEMA_TYPE = MetadataTypes\Sources\Connector::NS_PANEL->value . '/channel/' . Entities\Channels\ColorTemperature::TYPE;
