...
/**
 * NS Panel percentage channel entity schema
 *
...
final class Percentage extends Channel
{
	 ...
	 */
	public const SCHEMA_TYPE = MetadataTypes\Sources\Connector::NS_PANEL->value . '/channel/' . Entities\Channels\Percentage::TYPE;
