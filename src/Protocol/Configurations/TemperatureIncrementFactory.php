...
/**
 * TemperatureIncrementFactory.php
 *
...
/**
 * NS panel temperature increment capability configuration factory
 *
 * @package        FastyBird:NsPanelConnector!
 * @subpackage     Protocol
 *
 * @author         Adam Kadlec <adam.kadlec@fastybird.com>
 */
class TemperatureIncrementFactory implements ConfigurationFactory
{
	...
	): TemperatureIncrement
	{
		...
		return new TemperatureIncrement(
			$id,
			$capability,
			$value,
			floatval($minValue),
	...
	{
		return Types\Configuration::TEMPERATURE_INCREMENT;
	}
