...
/**
 * NS panel temperature scale capability configuration factory
 *
 * @package        FastyBird:NsPanelConnector!
 * @subpackage     Protocol
 *
 * @author         Adam Kadlec <adam.kadlec@fastybird.com>
 */
class TemperatureScaleFactory implements ConfigurationFactory
{
	...
	): TemperatureScale
	{
		...
		return new TemperatureScale($id, $capability, $value);
	}

	public function getType(): Types\Configuration
	{
		return Types\Configuration::TEMPERATURE_SCALE;
	}
