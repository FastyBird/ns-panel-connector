...
/**
 * NS panel color temperature attribute factory
 *
 * @package        FastyBird:NsPanelConnector!
 * @subpackage     Protocol
 *
 * @author         Adam Kadlec <adam.kadlec@fastybird.com>
 */
class ColorTemperatureFactory implements AttributeFactory
{
	...
	{
		return new ColorTemperature($id, $capability);
	}

	public function getType(): Types\Attribute
	{
		return Types\Attribute::COLOR_TEMPERATURE;
	}
