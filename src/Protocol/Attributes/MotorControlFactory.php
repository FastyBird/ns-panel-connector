...
/**
 * NS panel motor control attribute factory
 *
 * @package        FastyBird:NsPanelConnector!
 * @subpackage     Protocol
 *
 * @author         Adam Kadlec <adam.kadlec@fastybird.com>
 */
class MotorControlFactory implements AttributeFactory
{
	...
	{
		return new MotorControl($id, $capability);
	}

	public function getType(): Types\Attribute
	{
		return Types\Attribute::MOTOR_CONTROL;
	}
