...
/**
 * NS panel motor calibration attribute factory
 *
 * @package        FastyBird:NsPanelConnector!
 * @subpackage     Protocol
 *
 * @author         Adam Kadlec <adam.kadlec@fastybird.com>
 */
class MotorCalibrationFactory implements AttributeFactory
{
	...
	{
		return new MotorCalibration($id, $capability);
	}

	public function getType(): Types\Attribute
	{
		return Types\Attribute::MOTOR_CALIBRATION;
	}
